...
старый файл с макетами: "2017-03-26_Linkx_Desktop_v6.pdf", md5: "9c 16 d5 69 30 12 dd fe a3 38 ef 1a f3 00 4a 1d")
 - В авторизации:
   - оставляем авторизацию по паролю (у нас классическая аудитория, все-таки нужен такой подход), но кнопки-ссылки "Forgot password" больше не будет, а повторная отсылка пароля будет вызываться кнопкой "Resend"
...
# Модули:
   ...
   * Авторизация по телефону/email (стр.1-5)
     * [ОТМЕНЕНО.ОСВОБОЖДЕНО 1ч-2ч-4ч] - вёрстка стартового блока с выбором вариантов авторизации (стр.2 старых макетов) - остается выбор авторизации при нажатии на тексте by pass или by mobile/email 
	 ...
	 * Процесс авторизации - 1ч/1ч/1ч
	   - Выбор авторизации по паролю или имейлу/телефону кликая на вариант в тексте сверху:
